...
ARWA_create_intel_menu = {
	...
	_box addAction [[localize "ARWA_STR_STEAL_INTEL", 0] call ARWA_add_action_text, {
		...
		private _time_left_to_capture = ARWA_capture_time - _capture_progress;
		...
		systemChat format["_time_left_to_capture: %1, _stolen_manpower: %2, _intel_visibility: %3", _time_left_to_capture, _stolen_manpower, _intel_visibility];
...
ARWA_add_visible_markers = {
	...
	private _min_time_with_padding = _stolen_intel_time_min < 10 ? format["0%1", _stolen_intel_time_min] : _stolen_intel_time_min;
	private _sec_time_with_padding = _stolen_intel_time_sec < 10 ? format["0%1", _stolen_intel_time_sec] : _stolen_intel_time_sec;
