ARWA_paradrop_action = {
	params ["_ammo_box"];
	private _actionId = _ammo_box addAction [[localize "ARWA_STR_REQUEST_PARADROP", 0] call ARWA_add_action_text, {
...
ARWA_pick_paradrop_location = {
	...
	onMapSingleClick {
		...
		private _nearby_units = units (group player) select { player distance2d _x < 100; };
