...
["Request helicopter pick-up", helicopter, arwa_air_transport_actions] spawn show_order_transport;
["Request vehicle pick-up", vehicle1, arwa_ground_transport_actions] spawn show_order_transport;
